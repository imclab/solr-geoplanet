...
def import_timezones(timezones):

    solr = pysolr.Solr(opts.solr)
    docs = []

    datadir = os.path.join(timezones, 'data')
...
if __name__ == '__main__':
    ...
    # As in: https://github.com/straup/whereonearth-timezone

    parser = optparse.OptionParser("""import-timezones.py --options /path/to/whereonearth-timezone""")
    ...
    if len(args) == 0:
        logging.error("You forgot the timezones")
        sys.exit()
